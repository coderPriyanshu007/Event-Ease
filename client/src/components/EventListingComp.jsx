                  ...
                  }
                  {
                    booking  ? (
                      ...
                      (<button
                        ...
                        className={`h-[36px] ${currentDate >= eventDate ? 'opacity-[0.8] bg-red-600' : 'opacity-[1] bg-red-500 hover:bg-red-600'}   text-white px-4 py-2 rounded text-center text-sm`}
                      >
                      {event.capacity!==event.seats ? 'Book Now': 'Bookings Closed'}
                      </button>)
                  }
                </div>
              )
